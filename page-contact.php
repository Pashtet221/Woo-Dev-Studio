            ...
            <div>
                ...
                <form class="contact-form" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="contact-form__footer contact-form__field--wide">
                        <label class="contact-form__consent"><input type="checkbox" name="contact_consent" value="1" required><span>I agree that Woo Dev Studio may use these details to respond to my enquiry. <a href="<?php echo esc_url(home_url('/privacy-policy/')); ?>">Privacy policy</a>.</span></label>
